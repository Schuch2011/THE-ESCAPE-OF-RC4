...
function scene:create(event)
	...
	local titleText = display.newText(sceneGroup,"CHARACTER UNLOCKED!", W*.5,H*.06, native.systemFontBold, 25)
	...
	local charDescriptionTitleText = display.newText(sceneGroup, "SPECIAL ABILITY", W*.75, H*.55, native.systemFontBold, 21)
	local charDescriptionText = display.newText(sceneGroup, charDescription, W*.75, H*.65, native.systemFont, 21)
